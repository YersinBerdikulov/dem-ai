...
import { getMatchingItemsProgress } from '../../../../../config/getMatchingItemsProgress';
import { auth } from '../../../../../config/firebase';
import styles from '../../../../../styles/Games/matchingItemsStyles';
...
const MatchingItems = () => {
  ...
  const navigateToGameLevel = (levelNumber) => {
    navigation.navigate('MatchingItemsLevels', { level: levelNumber });
  };
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.logoContainer}>
          <Image 
            ...
            resizeMode="contain"
          />
          <Text style={styles.gameTitle}>{t('games.matchingItems')}</Text>
        </View>
        ...
        <View style={styles.benefitsSection}>
          ...
          <View style={styles.benefitsContainer}>
            <View style={styles.benefitItem}>
              ...
              <Text style={styles.benefitText}>{t('games.memory')}</Text>
            </View>
            ...
            <View style={styles.benefitItem}>
              ...
              <Text style={styles.benefitText}>{t('games.concentration')}</Text>
            </View>
            ...
            <View style={styles.benefitItem}>
              ...
              <Text style={styles.benefitText}>{t('games.thinking')}</Text>
            </View>
          </View>
        </View>
