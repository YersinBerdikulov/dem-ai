...
import { getConnectDotsProgress } from '../../../../../config/getConnectDotsProgress';
import { auth } from '../../../../../config/firebase';
import styles from '../../../../../styles/Games/connectDots';
...
const ConnectDotsGame = () => {
  ...
  useEffect(() => {
    const fetchUserProgress = async () => {
      try {
        ...
        if (currentUser) {
          const progress = await getConnectDotsProgress(currentUser.uid);
  ...
  const navigateToGameLevel = (levelNumber) => {
    navigation.navigate('ConnectDotsLevels', { level: levelNumber });
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.logoContainer}>
          <Image 
            source={require('../../../../../assets/games/connectdots-logo.png')} 
            style={styles.gameLogo}
            resizeMode="contain"
          />
          <Text style={styles.gameTitle}>{t('games.connectTheDots')}</Text>
        </View>
